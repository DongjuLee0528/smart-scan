...
MAIN_QUICK_REPLIES = [
    {"label": "View List",     "action": "message", "messageText": "목록"},
    {"label": "Add Item",      "action": "message", "messageText": "추가"},
    {"label": "Delete Item",   "action": "message", "messageText": "삭제"},
    {"label": "Disconnect Device", "action": "message", "messageText": "기기 해제"},
]
